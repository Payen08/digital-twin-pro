                        ...
                        <div className="glass-panel rounded-lg p-1.5 flex flex-col gap-1 shadow-xl bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/5">
                            {currentScene.floorLevels.map((floor) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200 min-w-[60px] ${
...
<<<<<<< HEAD
                {/* FIGMA PREVIEW BUTTON - 已隐藏 */}
                {false && (
                    <div className="absolute top-4 right-6 z-[9999] flex gap-3">
                        <button 
                            onClick={() => window.openFigmaPreview && window.openFigmaPreview()}
                            onMouseDown={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                                if (window.openFigmaPreview) {
                                    window.openFigmaPreview();
                                }
                            }}
                            className="glass-panel p-1.5 bg-[#080808] rounded-lg transition-colors text-gray-400 hover:text-white hover:bg-blue-600 flex items-center justify-center cursor-pointer"
                            title="打开 Figma 原型"
                        >
                            <Play size={18} />
                        </button>
...
>>>>>>> 14447407d9b9c4af3c65e155929cd93e6711f2ed
